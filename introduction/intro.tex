...
The laboratory is present on three sites located in Lille (\ac{ENSAM} and \ac{ONERA}) and on the Villeneuve d'Ascq campus (Centrale Lille, \ac{CNRS}, University of Lille).
