...
The main objective of this internship is to improve the numerical simulation of a centrifugal pump using experimental data through \ac{DA}. This allow to improve the understanding of the physical phenomena involved in the pump's operation and then to optimize its performance.
...
\begin{itemize}\setlength\itemsep{0.1em}
    ...
    \item Ensuring the convergence of the CFD solution using IBM;
    \item Implementing the DA problem in \ac{OpenFOAM} and \ac{CONES};
    \item Optimizing the forcing parameters of the IBM using DA with CONES to correct a non-physical behavior.
\end{itemize}
