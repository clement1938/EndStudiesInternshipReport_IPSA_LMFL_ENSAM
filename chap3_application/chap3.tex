...
\begin{figure}[H]
    ...
    \caption{Velocity field for Dx = Dy, but with too high parameters, which made the simulation diverge}
    \label{fig:diverged}
\end{figure}
...
Initial values are $(a,b,c) = (0, 0, 3e7)$ for all four forcing terms, with an absolute variance of $(1e7,1e7,1e6)$.
...
The \autoref{fig:radialExpension2} shows the radial expansion of the four forcing terms after a few DA analysis. Globally, curves looks like going a bit down. 
...
\begin{figure}[H]
    ...
    \begin{subfigure}{0.8\textwidth}
        ...
        \caption{Velocity field obtained a few iterations after enforcing $\omega r$.}
        \label{fig:omega_r2}
    \end{subfigure}
    ...
    \begin{subfigure}{0.8\textwidth}
        ...
        \caption{Velocity field obtained long after enforcing $\omega r$, confirming the suppression of the recirculation bubble.}
        \label{fig:omega_r3}
    \end{subfigure}
...
This ad-hoc strategy partially alleviates the issue of the recirculation bubble, as illustrated in \autoref{fig:omega_r}, but it also introduces secondary instabilities and lacks a rigorous physical basis. Nevertheless, these results suggest that directly enforcing the target velocity profile can effectively reproduce the wall boundary conditions. This observation indicates that it could be relevant to reconsider the penalisation-based IBM implementation within the PIMPLE algorithm, for instance by modifying the way the forcing term is imposed, in order to obtain a more stable and physically consistent treatment of the boundaries.
