...
\tikzset{
  ...
  file/.pic={
    ...
    \node at (0.5*\Size, 0.5*\Size) {\includegraphics[width=0.4cm]{images/file.png}}; % Remplace l'image par celle de ton choix
  }
}
...
\fancypagestyle{plain}{
  ...
  \fancyhead[R]{\includegraphics*[width=0.25\textwidth]{images/logos.png}}
...
\fancyfoot[R]{\includegraphics*[width=0.1\textwidth]{images/ipsagarde.png}}
  ...
  \centering
  {\includegraphics[width=\paperwidth,height=0.30\paperheight, %\transparent{0.4}
  keepaspectratio]{images/ipsagarde.png}}
  \vspace{2.0cm} % Adjust the spacing between the image and the title
  \makebox[\paperwidth]{\textbf{TITRE IMAGE PAGE DE GARDE}} % Center the title below the image
  }}}
...
\printacronyms[name=List of acronyms, heading=chapter*] % Glossaire après si besoin
