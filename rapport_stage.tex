...
\begin{itemize}
    \item \textbf{Appendix 1} - Batch code used to run simulation on the Rome partition of TGCC cluster \dotfill \pageref{annex:BatchCode}
    \item \textbf{Appendix 2} - Discretization and coupling in OpenFOAM (RANS / U\,-RANS) \dotfill \pageref{annex:OpenFOAMRANS}
    \item \textbf{Appendix 3} - OpenFOAM Directory Tree \dotfill \pageref{annex:OpenFoamArbo}
    \item \textbf{Appendix 4} - Extract of conesDict file \dotfill \pageref{annex:conesDict}
