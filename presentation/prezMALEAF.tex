...
\usetheme{Boadilla}
\useoutertheme{miniframes}          % ou smoothbars pour version plus fluide
\setbeamertemplate{mini frame}[circle] % cercles au lieu de rectangles
\setbeamertemplate{mini frame in other subsection}[default][20] % griser les diapos hors section courante
...
\setbeamertemplate{frametitle}{%
  \nointerlineskip%
   ...
   \begin{beamercolorbox}[wd=\paperwidth,leftskip=.1cm,rightskip=.3cm plus1fil,vmode]{frametitle}%
        ...
        \begin{flushleft}
            \includegraphics[width=\linewidth, keepaspectratio, trim={0 3cm 0 3cm}, clip]{../logos/logos.png}
%\includegraphics[height=1cm, trim = {0 3cm 0 3cm}, clip]{../logos/logos.png}% width=1.6cm, 
        \end{flushleft}
        \end{minipage}%
        \begin{minipage}{13cm}%
        \vspace{0.25cm}
