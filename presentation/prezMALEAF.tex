...
% https://www.researchgate.net/figure/LES-simulation-of-a-turbulent-flame-with-evaporating-droplets-11_fig11_268223531
    ...
    \begin{frame}{Laboratoire et site d'acceuil}
        %\begin{columns}
            %\begin{column}{0.40\textwidth}
                \center
                \includegraphics[scale=0.3]{../images/combo-LMFL.png}
            ...
            %\begin{column}{0.60\textwidth}
                \begin{enumerate}
                    ...
                    \item \textbf{Ecoulements tourants}
                \end{enumerate}
            %\end{column}
        %\end{columns}
    \end{frame}
    ...
    \begin{frame}{Etapes intermédiaires}

        \textbf{Objectif du stage} : améliorer la performance d'une pompe centrifuge en utilisant des techniques d'assimilation de données (DA) pour ajuster les paramètres du modèle numérique.

        \vspace{0.3cm}

        \begin{itemize}
            \item Mettre en avant les limitations de la méthode aux fontières immergées (IBM) dans le contexte des pompes centrifuges.
            \item Déterminer et préparer les données expérimentales disponibles qui seront utilisées pour l'assimilation.
            \item Intégrer une méthodologie d'assimilation de données, basée sur le filtre de Kalman d'ensemble (EnKF), adapté à la simulation numérique de la pompe.
            \item Trouver une combinaison optimale des coefficients de pénalisation IBM pour améliorer la précision de la simulation.
            %\item Valider les résultats obtenus par rapport aux données expérimentales.
        \end{itemize}
    \end{frame}

    
    \begin{frame}{Mécanique des fluides}
        \vspace{-0.4cm}
        ...
        \begin{tikzpicture}[
                ...
                bigbox/.style={
                    ...
                    thick,
                    inner sep=0.2cm,
                    label={[font=\bfseries]above:CONES}
                }
            ]
        ...
        \begin{columns}[T]
            ...
            \begin{column}{0.55\textwidth}
                \begin{block}{Équations de Navier–Stokes incompressibles}
                    ...
                    \]
                    \[
                    Moment : \rho \left( \frac{\partial \mathbf{u}}{\partial t} + \mathbf{u}\cdot\nabla \mathbf{u} \right)
                    = -\nabla p + \mu \nabla^2 \mathbf{u}
                    \]
                \end{block}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    \begin{frame}{Conclusion}
        \begin{itemize}
            \item<+-> {\color{green!60!black}\ding{51}}~ Mettre en avant les limitations de l'IBM dans le contexte des pompes centrifuges
            \item<+-> {\color{green!60!black}\ding{51}}~ Déterminer et préparer les données expérimentales disponibles qui seront utilisées pour l'assimilation
            ...
            \item<+-> {\color{orange}\textbullet}~ Valider les résultats obtenus par rapport aux données expérimentales
...
\begin{frame}
  ...
  \includegraphics[scale=0.25]{../images/blade_interpolation_1.png}
\end{frame}

\begin{frame}
  \frametitle{A4 : Autre résultat annexe}
    \includegraphics[scale=0.25]{../images/compensation_recirculation.png}
\end{frame}

\begin{frame}
  \frametitle{A5 : Autre résultat annexe}
    \includegraphics[scale=0.25]{../images/DNSLESRANS.png}
\end{frame}

\begin{frame}
  \frametitle{A6 : Autre résultat annexe}
    \includegraphics[scale=0.25]{../images/EnKF_Cones_français.pdf}
\end{frame}


\begin{frame}
  \frametitle{A7 : Autre résultat annexe}
    \includegraphics[scale=0.25]{../images/inflation.png}
\end{frame}

\begin{frame}
  \frametitle{A8 : Autre résultat annexe}
    \includegraphics[scale=0.25]{../images/MRF.png}
\end{frame}


\begin{frame}
  \frametitle{A9 : Autre résultat annexe}
    \includegraphics[scale=0.25]{../images/pv_x.png}
\end{frame} 

\begin{frame}
  \frametitle{A10 : Autre résultat annexe}
    \includegraphics[scale=0.25]{../images/SHF_impeller_characteristics.png}
\end{frame}

\begin{frame}
  \frametitle{A11 : Autre résultat annexe}
    \includegraphics[scale=0.25]{../images/sketch-turbulent-flow-modeling-DNS-LES-RAS.png}
\end{frame} 
...
\begin{frame}
  \frametitle{A14 : Autre résultat annexe}
    \includegraphics[scale=0.25]{../images/turbCascade.png}
\end{frame} 
...
\begin{frame}
  \frametitle{A17 : Autre résultat annexe}
  \includegraphics[scale=0.25]{../images/model/Digital_Twin_pump.pdf}
\end{frame}

\begin{frame}
  \frametitle{A18 : Autre résultat annexe}
  \includegraphics[scale=0.25]{../images/numericalPump/impeller_cells.pdf}
\end{frame}

\begin{frame}
  \frametitle{A19 : Autre résultat annexe}
  \includegraphics[scale=0.25]{../images/other/DAmap.png}
\end{frame}

\begin{frame}
  \frametitle{20 : Maillage}
  \includegraphics[scale=0.25]{../images/model/Digital_Twin_pump.pdf}
\end{frame}
