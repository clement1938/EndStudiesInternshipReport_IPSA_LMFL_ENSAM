...
\node[right=0.2cm, yshift=-1.6cm] at (current page.150){
	\includegraphics[width=2.0cm]{../logos/both2.png}
};
\end{tikzpicture}
...
\node[left=0.2cm, yshift=-1.6cm] at (current page.30){
	\includegraphics[width=2.0cm]{../logos/IPSA.png}
};
\end{tikzpicture}
}
...
\author[Clément THIBAULT]{
  Clément THIBAULT\texorpdfstring{\textsuperscript{\dag}}{\dag}
}
\institute{\textsuperscript{{\dag}} Institut Polytechnique des Sciences Avancées (IPSA) Toulouse - Laboratoire de Mécanique des fluides de Lille (LMFL)} % Univ. Lille, CNRS, ONERA, Arts et Métiers ParisTech, Centrale Lille, UMR 9014-  - Kampé de Feriet, F-59000 Lille, France
...
\begin{comment}
    ...
    \begin{beamercolorbox}[wd=\paperwidth,leftskip=.1cm,rightskip=.3cm plus1fil,vmode]{frametitle}%
            ...
            \begin{flushleft}
                \includegraphics[height=1cm, width=1.6cm, trim = {0 3cm 0 3cm}, clip]{../logos/Logo ENSAM.png}\hspace*{0.3cm}%
                \includegraphics[height=1cm, width=1.6cm]{../logos/Logo LMFL.png}%
            \end{flushleft}
            \end{minipage}%
            \begin{minipage}{9cm}%
            \vspace{0.25cm}
        ...
        \fi%%
            ...
            \begin{flushleft}
                \includegraphics[height=0.8cm, width=1.3cm]{../logos/IPSA.png}%
            \end{flushleft}
            \end{minipage}%
    \end{beamercolorbox}%
    \vskip-0.05cm
...
\setbeamertemplate{frametitle}{%
  \nointerlineskip%
   ...
   \begin{beamercolorbox}[wd=\paperwidth,leftskip=.1cm,rightskip=.3cm plus1fil,vmode]{frametitle}%
        ...
        \begin{flushleft}
            \includegraphics[height=1cm, width=1.6cm, trim = {0 3cm 0 3cm}, clip]{../logos/Logo ENSAM.png}\hspace*{0.5cm}%
            \includegraphics[height=1cm, width=1.6cm]{../logos/Logo LMFL.png}%
        \end{flushleft}
        \end{minipage}%
        \begin{minipage}{9cm}%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{État de l'art} % La base de la CFD, ...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Ingrédients numériques} 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Données du cas d'étude} 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Préparation du cas d'étude} 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\section{Résultats}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{DA avec le Filtre de Kalman d'ensemble}
