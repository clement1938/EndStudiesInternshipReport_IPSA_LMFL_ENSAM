...
\title[\textcolor{white}{Stage de fin d'études}]{
  \texorpdfstring{\structure{Optimisation de la prédiction de la performance d'une pompe centrifuge par assimilation de données}}
        ...
        %\begin{columns}
            ...
            %\begin{column}{0.60\textwidth}
                ...
                \begin{enumerate}
                    ...
                    \item \textcolor{red}{\textbf{Écoulements tournants}}
                \end{enumerate}
            %\end{column}
        %\end{columns}
    \end{frame}
