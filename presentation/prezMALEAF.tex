        ...
        %\begin{columns}
            ...
            %\begin{column}{0.60\textwidth}
                \begin{enumerate}
                    ...
                    \item \textcolor{red}{\textbf{Ecoulements tourants}}
                \end{enumerate}
            %\end{column}
        %\end{columns}
    \end{frame}
...
\begin{columns}[T]
    ...
    \begin{column}{0.45\textwidth}
        ...
        \begin{itemize}
            \item OpenFOAM
            \item IBM
            \item Pompe centrifuge avec 4 inserts
        \end{itemize}
        \end{block}
    \end{column}
...
\begin{block}{Objectif}
    Combiner \textbf{CFD + expérimental}
\end{block}
...
\centering
\textbf{Optimiser :} coefficients $D_u, D_\mathcal{K}, D_\omega$
