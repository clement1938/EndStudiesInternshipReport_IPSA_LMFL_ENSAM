...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    \begin{frame}{Laboratoire et site d'acceuil}
        \begin{columns}
            \begin{column}{0.60\textwidth}
                \includegraphics[scale=0.25]{../images/other/LMFL_facilities.png}
            \end{column}
    ...
    \begin{frame}{Sujet du stage}
        ...
        \begin{itemize}
            ...
            \item \textbf{mécanique des fluides numérique numériquee} : important pour la prédiction du comportement physique, la conception et l'optimisation, mais confrontée à la complexité des écoulements.
    ...
    \begin{frame}{État de l'art}
        \begin{itemize}
            \item Context/Problématique : Pk je fais ça ?
            \item Ce qui se fait au labo
            \item-> Importance de la simulation numérique pour améliorer la performance des pompes centrifuges.
            \item-> Avantages et limitations des modèles numériques actuels
            \item-> Avantage et limitations des données expérimentales
            \item-> Rôle de l'assimilation de données pour améliorer la précision des simulations.
        \end{itemize}
    \end{frame}
    ...
    \centering
        \begin{tikzpicture}[
            ...
            \draw[arrow] (openfoam.south) -- (model.north);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Données et préparation du cas d'étude} 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\includegraphics[scale=0.5]{../images/profil_pression_entrancePipe.png}

\begin{frame}{Expérimentale}
    ...
    \begin{columns}
        ...
        \begin{column}{0.3\textwidth}
            ...
            \includegraphics[scale=0.31]{../figures/RESEDA_benchmark.png}
                %\end{column}
                %\begin{column}{0.458\textwidth}
            \includegraphics[scale=0.20]{../figures/image1.png}
        \end{column}
            %\end{columns}
        %\end{column}
...
\begin{frame}{Modélisation avec la méthode de frontières immergées}
...
\section{Résultats}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% DA avec le Filtre de Kalman d'ensemble
...
\begin{frame}{Limitations de la méthode IBM}
    ...
    \only<1>{%
        \centering
        \includegraphics[width=0.9\linewidth]{../newFigures/LIC_Uy.png} \\
        \vspace{0.2cm}
    ...
    \only<2>{%
        \centering
        \includegraphics[width=0.9\linewidth]{../newFigures/LIC.png} \\
        \vspace{0.2cm}
...
\begin{frame}{DA avec l'EnKF - Nouveaux paramètres}
    ...
    \begin{columns}[c]
        ...
        \column{0.48\textwidth}
            \begin{figure}
                \centering
                \includegraphics[width=0.6\linewidth]{../newFigures/radial_exp.png}
...
\begin{frame}{DA avec l'EnKF - Nouveaux paramètres}
    ...
    \begin{columns}[c]
        ...
        \column{0.48\textwidth}
            \begin{figure}
                \centering
                \includegraphics[width=1\linewidth]{../newFigures/coords.png}
