...
\node[left=0.2cm, yshift=-1.6cm] at (current page.30){
	\includegraphics[width=5.0cm]{../logos/logosbis.png}
};
\end{tikzpicture}
}
...
\end{comment}
    ...
    \begin{frame}{DA in fluid mechanics}
        \vspace{-0.4cm}
        \begin{columns}[T] % T = top align
            ...
            \begin{column}{0.50\textwidth}
                \begin{block}{\textbf{numerical simulation}}%{Simulation numérique}}
                    \begin{itemize}
                        \item Full field (speeds, pressures, etc.)
...
\begin{frame}{DA avec l'EnKF - Nouveaux résultats}
    ...
    \begin{figure}
        ...
        \only<1>{\includegraphics[width=0.65\linewidth]{../images/graph/NRMSE10.png}} %/newFigures/UpdtC14_10NMRSE.png}}
