...
\setbeamercolor{subsection in head/foot shaded}{fg=white}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    \begin{frame}{Objectifs}
        \begin{itemize}
            \item Mettre en avant les limitations de l'IBM dans le contexte des pompes centrifuges.
            \item Déterminer et préparer les données expérimentales disponibles qui seront utilisées pour l'assimilation.
            \item Intégrer une méthodologie d'assimilation de données, basée sur l'EnKF, adapté à la simulation IBM RANS de la pompe.
