            ...
            \begin{column}{0.50\textwidth}
                \begin{block}{\textbf{Simulation numérique}}
                    \begin{itemize}
                        ...
                        \baditem Précision limitée (turbulence, maillage, conditions limites, etc.)
                    \end{itemize}
                \end{block}
            \end{column}
    ...
    \begin{frame}{Assimilation de données avec EnKF}
        ...
        % Partie modèle
            \begin{column}{0.45\textwidth}
                ...
                \begin{itemize}
                    \item 35 simulations (RANS, k-$\omega$ SST)
                    \item OpenFOAM
                    \item IBM
                \end{itemize}
                \end{block}
...
\begin{frame}
    \begin{figure}
        \centering
        \includegraphics[width=0.7\linewidth]{../images/graph/UpdtC14_10params.png} % 
...
\begin{frame}
    \begin{figure}
        \centering
        \includegraphics[width=0.7\linewidth]{../images/graph/cdx.png} % 
        \caption{Evolution du coefficient c Dx de l'IBM au cours des itérations de l'EnKF}
        \label{fig:NRMSE2}
    \end{figure}
\end{frame}
...
\begin{frame}{DA avec l'EnKF - Nouveaux résultats}
    ...
    \begin{figure}
        ...
        \only<1>{\includegraphics[width=0.65\linewidth]{../newFigures/UpdtC14_10NMRSE.png}}
        % La deuxième image apparaît sur la deuxième étape (<2>)
        \only<2>{\includegraphics[width=0.65\linewidth]{../images/graph/NRMSEcdx.png}}
...
\begin{frame}{DA avec l'EnKF - Nouveaux paramètres}
    ...
    \begin{columns}[c]
        ...
        Évite un résultat de l'EnKF où les paramètres de l'IBM cassent la périodicité.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    \begin{frame}{Perspective : simulation instationnaire}
        ...
        \begin{columns}[c]
            ...
            \column{0.48\textwidth}
                \animategraphics[loop, autoplay, width=0.45\linewidth]{2}{../images/rotating/}{1}{5}
                \scriptsize Rotation de la partie pénalisée, parallélisé sur 4 cœurs
            
            \column{0.48\textwidth}
                \includegraphics[width=1\linewidth]{../images/rotating/3bis.png}
