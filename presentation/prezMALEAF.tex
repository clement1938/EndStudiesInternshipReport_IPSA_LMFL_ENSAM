    ...
    \begin{frame}{Laboratoire et site d'acceuil}
        %\begin{columns}
            %\begin{column}{0.40\textwidth}
                \includegraphics[scale=0.5]{../images/combo-LMFL.png}
                \scriptsize LES simulation of a turbulent flame with evaporating droplets
            %\end{column}
        ...
        \begin{columns}[t] % Alignement en haut
            ...
            \begin{column}{0.50\textwidth}
                ...
                \begin{flushleft}
                    ...
                    \vspace{0.5cm}
                    \center
                    \includegraphics[scale=0.20]{../images/PompeCentrifuge.png} \\
            ...
            \begin{column}{0.50\textwidth}
                \begin{flushleft}
                    \center
                    \includegraphics[scale=0.20]{../images/CFD.png} \\
