...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    \begin{frame}{Sujet du stage}
        \begin{columns}
            ...
            \begin{column}{0.40\textwidth}
                \includegraphics[scale=0.22]{../images/PompeCentrifuge.png}
                \scriptsize Pompe centrifuge
                \includegraphics[scale=0.22]{../images/CFD.png}
            \end{column}
...
\begin{frame}{DA avec l'EnKF - Nouveaux résultats}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.7\linewidth]{../newFigures/UpdtC14_10NMRSE.png} % 
        \caption{Bulle de recirculation localement détruite}
        \label{fig:10NRMSE}
    \end{figure}

    Diminution moyenne de la NRMSE de quelques \%, avec des variations de paramètres dépendantes des conditions initiales.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    \begin{frame}{A venir}
        \begin{columns}
            ...
            \end{column}
            \begin{column}{0.45\textwidth}
                \textbf{Thèse :} Combinaison de techniques expérimentales et numériques pour l'analyse des écoulements internes des compresseurs axiaux par assimilation de données
