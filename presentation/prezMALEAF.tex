...
% https://www.researchgate.net/figure/LES-simulation-of-a-turbulent-flame-with-evaporating-droplets-11_fig11_268223531
    ...
    \begin{frame}[t]{Corporate Social Responsibility (CSR)}
        ...
        \begin{itemize}
            ...
            \item Education and training -> ecor-responsibility
            \item Research and innovation free acces
        ...
        \textbf{LMFL action plan :} "Haut Conseil de l'Évaluation
de la Recherche et de l'Enseignement Supérieur" (HCERES)
        \begin{itemize}
            ...
            \item Synergy between geographically separated
sites
    ...
    \begin{frame}{Modèle numérique de la pompe centrifuge} % Modélisation
        \begin{columns}
            \begin{column}{0.48\textwidth}
                \includegraphics[scale=0.45]{../figures/RESEDA_sketchBis.pdf}
                \scriptsize Modèle de la pompe centrifuge RESEDA
    ...
    \begin{frame}{La mécanique des fluides numérique}
        ...
        \begin{columns}[T]
            ...
            \begin{column}{0.45\textwidth}
                ...
                \vspace{-0.31cm}
                \begin{figure}
                    \includegraphics[width=0.70\textwidth]{../images/turbulence2.jpg}\\
...
%\end{equation*}
    ...
    \begin{frame}{CONES}
        \begin{center}
            \includegraphics[scale=0.55]{../images/EnKF_Cones_français.pdf} % ou RESEDA_sketch.pdf
...
\begin{frame}
  \frametitle{A21 : Penalisation IBM nulle}
  \begin{center}
    \includegraphics[scale=0.25]{../newFigures/pen0.png}
  \end{center}
\end{frame}
