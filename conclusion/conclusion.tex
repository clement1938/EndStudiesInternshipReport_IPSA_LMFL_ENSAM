...
The DA method still has a strong potential for industrial applications, but its use faces challenges: reducing the computational cost, improving convergence, and adapting algorithms to complex geometries and real-time constraints. Exploring hybrid strategies, for instance coupling DA with machine learning techniques, could help overcome some of these barriers. In parallel, improving IBM formulations is essential to better capture wall effects and provide physically consistent flow predictions.
