...
Plan 0 repartir d'une simu convergé avec les nouveaux schémas (4e7 puis 5e7)

Plan a : plus raffiner autour de la sortie de la roue / entrée du diffuseur

Plan b : modèle de turbulence k-epsilon

viscosité turbu de 09? to 0. (à augementer ?)

Plan c : expension des valeurs (radial puis azimutale ? -> trouver une fonction approximative de la forme de la pale et la "convoluer" avec la fonction voulu) (selon karhunen loeve expansion) en majorant au niveau de la sortie de la roue
