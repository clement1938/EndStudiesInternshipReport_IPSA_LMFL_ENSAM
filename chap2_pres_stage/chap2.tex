...
Plan c : expension des valeurs (radial puis azimutale ?) (selon karhunen loeve expansion) en majorant au niveau de la sortie de la roue
...
\begin{figure}[H]
    ...
    \caption{The big picture for DA methods and algorithms}
    \label{fig:DAmap}
\end{figure}
...
Results in the file are High-Speed \ac{PIV} data obtained at a PIV frequency of 980 Hz
