...
\begin{itemize}
    \item High-Speed \ac{PIV} data\cite{dazinHighspeedStereoscopicPIV2011a} obtained by Antoine Dazin in 2011;
    \item Pressure data\cite{fanEffectLeakagePerformanceb} obtained by Meng Fan in 2022.
\end{itemize}

M. Fan has also capture the inlet and outlet pressure that allow to compute the performance of the pump, which is defined as ...///

// Ajouter des images de la pompe, de l'expérience, des PIV, des pressions, diffuseur etc. //
