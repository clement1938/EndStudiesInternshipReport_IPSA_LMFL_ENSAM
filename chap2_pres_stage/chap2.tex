...
Calcul du deltaT de la simu pimple de la pompe :
Vitesse de rotation : 1200rmp soit 20tr/S (0.05s/tr)
Supposons que nous (1/49)tr/it
Alors dt = 1/(49*20) = 1/FPS = 1/980 = 0.0010204081632653062
...
Par rapport à l'aléatoire, les variation sont random mais avec une graine de reproducibilité (sed) qui permet d'avoir le même résultat à chaque fois qu'on lance la simulation.
...
Peut-être faire deux filtres de Kalman (ouverture)
