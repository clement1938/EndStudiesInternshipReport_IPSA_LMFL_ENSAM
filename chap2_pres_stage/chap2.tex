...
M. Fan has also capture the inlet and outlet pressure that allow to compute the performance of the pump, which is defined as -> see part XX...///

// Ajouter des images des PIV //
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{images/PIV_measurements_sketch.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{images/PIV_measurements_sketch.pdf}
    \caption{Position of the PIV plans}
    \label{fig:PIVPlans}
\end{figure}
...
// Ici j'ai présenté les données XP, je parlerais de leurs traitement dans la partie 2.4.1
