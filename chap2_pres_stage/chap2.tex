...
Expliquer  théorème de Bayes etc... dans la partie maths ? (c'est ici ?)
...
Expliquer en quoi / cas test ou ca a fonctionné en CFD en utilisant des paramètres écoulement. -> cas test cavity
...
\begin{figure}[H]
    ...
    \subfigure[Initial state]{
        \includegraphics[width=0.3\textwidth]{images/cavity2_1ms.png}
        \label{fig:cavity2_1ms}
    }
    \hfill
    \subfigure[State after one EnKF iteration]{
        \includegraphics[width=0.3\textwidth]{images/cavity2_3ms.png}
        \label{fig:cavity2_3ms}
    }
    \hfill
    \subfigure[Converged state after 2 EnKF iterations]{
        \includegraphics[width=0.3\textwidth]{images/cavity_5ms.png}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.3\textwidth}
        \includegraphics[width=\textwidth]{images/cavity2_1ms.png}
        \caption{Initial state}
        \label{fig:cavity2_1ms}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.3\textwidth}
        \includegraphics[width=\textwidth]{images/cavity2_3ms.png}
        \caption{After one EnKF it.}
        \label{fig:cavity2_3ms}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.3\textwidth}
        \includegraphics[width=\textwidth]{images/cavity_5ms.png}
...
Et là cas tests de thèse miguel (1 et 2)
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.45\textwidth]{images/other/pompe_centrifuge.jpg}
    \caption{Old centrifugal pump used to move straw (personnal picture)}
...
\begin{figure}[H]
    ...
    \caption{METTRE LA FIGURE AVEC LES PTS MOYENNES ROUGES ET VIOLETS}
    \label{CHANGER}
\end{figure}
