...
- Modèle proche parois kOmegaSST
...
\begin{center}
    ...
    \end{forest}
    \captionof{figure}{OpenFOAM directory structure}
    \label{fig:openfoam-directory}
\end{minipage}
\end{center}
...
\section{Presentation of the pump}
...
\section{Modifications on OpenFoam and CONES}
\subsection{Modifications on the interpolation function}
