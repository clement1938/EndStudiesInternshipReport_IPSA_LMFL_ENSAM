...
Ouverture : méthode IBM interpolation, citer l'article ??
...
%%Nbr de processeurs : sur rome : 128 coeurs par noeuds, 30 membres d'ensemble + python : 127×30+1 = 3811 arrondi à 3840 car noeuds complets : 30 noeuds

%En combien de temps l'information de pression remonte-t-elle dans le diffuseur ?
%Peut-être faire deux filtres de Kalman imbriqués ?(ouverture)
...
#MSUB -q rome
#MSUB -A gen1741
#MSUB -n 4446 # 35*127 + 1
#MSUB -c 2  # To change if necessary
##MSUB -N 1 # Nb of calcul node
#MSUB -T  43200  # Execution time in seconds (12h)
##MSUB -Q long # (upto 3 days)
##MSUB -Q test # (short, high priority jobs)
#MSUB -m scratch
##MSUB -@ clement.thibault@ipsa.fr:begin,end

set -x
cd ${BRIDGE_MSUB_PWD}
module purge
module load gnu/8 mpi/openmpi/4 flavor/python3/cuda python3/3.10.6 openfoam/9 ; source $FOAM_SOURCE_FILE
...
ccc_mprun -f app_mySF35.conf
\end{verbatim}




S'aider du plan de la présentation MALEAF
