\begin{titlepage}
    ...
    \begin{center}
        ...
        \begin{tabularx}{\textwidth}{>{\raggedright\arraybackslash}X
            ...
            \includegraphics[scale=0.28]{images/ipsagarde.png} &
            \includegraphics[scale=3.1]{images/logo_lmfl-300x138.png} &
            \includegraphics[scale=0.51]{images/logo-artsEtM-322x84.png} \\
